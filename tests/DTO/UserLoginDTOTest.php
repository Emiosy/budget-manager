...
class UserLoginDTOTest extends TestCase
{
    ...
    public function testPasswordNoLengthRestriction(): void
    {
        // Login DTO doesn't have minimum password length restriction (unlike registration)
        $dto = new UserLoginDTO();
        $dto->email = 'test@example.com';
        $dto->password = '1'; // Very short password
    ...
    public function testWhitespaceInPassword(): void
    {
        $dto = new UserLoginDTO();
        $dto->email = 'test@example.com';
        $dto->password = 'password with spaces';
    ...
    public function testUnicodeCharactersInPassword(): void
    {
        $dto = new UserLoginDTO();
        $dto->email = 'test@example.com';
        $dto->password = 'пароль123'; // Cyrillic characters
    ...
    public function testNumericOnlyPassword(): void
    {
        $dto = new UserLoginDTO();
        $dto->email = 'test@example.com';
